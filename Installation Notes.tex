...
Namely,
	\begin{numberedlist}
		...
		\end{code}
		\item Check the environmental variable \textit{PATH} to ensure the MiKTeX path is included.  (To find the MiKTeX path you can use WidEdt and go to \textit{Options$\rightarrow$Execution Modes...$\rightarrow$Console Applications}.)  If it is not in the path, add it.
