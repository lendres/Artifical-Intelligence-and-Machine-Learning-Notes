	...
	\tabletitlefont{\bfseries\Large}
	\tablecolumnheaderfont{\bfseries}

	% Used to auto number table rows.
	\usepackage{array}
	\newcounter{tablerowcounter}[table]
	\renewcommand{\thetablerowcounter}{\thetable.\arabic{tablerowcounter}}
	
	% A new column type to apply automatic stepping
	\newcolumntype{N}{>{\refstepcounter{tablerowcounter}\thetablerowcounter}c}
