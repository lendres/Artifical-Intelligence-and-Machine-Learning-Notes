	...
	\newlength{\figureheretopspacing}
	\setlength{\figureheretopspacing}{10pt plus2pt minus2pt}
	\newlength{\figureherebottomspacing}
	\setlength{\figureherebottomspacing}{6pt plus2pt minus2pt}

	% Figure environment that does not float.  Caption is not allowed.
	\newenvironment{figurehere}
	{
		\vspace{\figureheretopspacing}
		% The 1.5 cm is double the indent of the numbered list.
