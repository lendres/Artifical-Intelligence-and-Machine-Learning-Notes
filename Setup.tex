	...
	\newcolumntype{P}{>{\raggedright\arraybackslash}p{1.22in}}
	\newcolumntype{Q}{>{\raggedright\arraybackslash}p{3.0in}}
	...
	% Prevents underfull warnings while creating the bibliography.  The bibliography uses the "sloppy" command.
