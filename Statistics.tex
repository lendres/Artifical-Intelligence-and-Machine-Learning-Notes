...
Type 2 error (false negative): Concluding there is not a change in probability when there is.
    ...
    \begin{topcaptiontable}
        ...
        \begin{tabular}{|N|p{1.25in}|p{3in}|p{1.25in}|} \hline
			...
			\tablerow & 
				...
				t-distribution (one sample t-test) \\ \hline
			\tablerow & 
				...
				\end{nospacebulletedlist} &
				Standard normal distribution (two independent sample z-test) \\ \hline
			\tablerow &
				Test for equality of two population means. $\nullhypothesis : \populationmean_1 = \populationmean_2$ &
				\begin{nospacebulletedlist}
					\item Continuous data
	...
	\begin{code}{}
		\codeitem testStatistic, pValue = scipy.stats.ttest\_1samp(\ldots)
	\end{code}