...
One-way \acrshort{anova}
	...
	\begin{figure}[tbp]
		...
		\caption{Levels versus factors for \acrshort{anova}.}
...
Type 2 error (false negative): Concluding there is not a change in probability when there is.
	...
	\begin{figure}[tbp]
		\centering
		\includegraphics[height=2.5in]{hypothesistests}
		\caption{}
	...
	\begin{figure}[tbp]
		\centering
		\includegraphics[height=2.5in]{hypothesisflowchart}
		\caption{}
		\label{fig:hypothesisflowchart}
	\end{figure}
...
%        \centering
%        \lecaption{Comparison of Hypothesis Test Types.  See the Jupiter notebook "Hypothesis Testing Statistical Learning Week 2" for more information and examples.}
