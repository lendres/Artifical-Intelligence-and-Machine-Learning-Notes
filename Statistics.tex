...
Type 2 error (false negative): Concluding there is not a change in probability when there is.
    ...
    \begin{topcaptiontable}
        \centering
        \lecaption{Comparison of }
        \label{tab:hypothesistests}
        \begin{tabular}{|N|p{1.25in}|p{3.08in}|p{1.2in}|} \hline
			\multicolumn{1}{|c|}{} & \tablecolumnheadervlines{Significance of Test} &
				\tablecolumnheadervlines{Assumptions} &
				\tablecolumnheadervlines{Distribution/Test} \\ \tabledoublecline{1}{4}
			...
			\label{trw:twopopulationmeans} & Test for equality of two population means. $\nullhypothesis : \populationmean_1 = \populationmean_2$ &
				\begin{nospacebulletedlist}
					\item Continuous data
			...
			\label{trw:p} & Test for equality of two population means. $\nullhypothesis : \populationmean_1 = \populationmean_2$ &
				\begin{nospacebulletedlist}
					\item Continuous data
				\end{nospacebulletedlist} &
				\distributiontest{distribution}{test} \\ \hline
        \end{tabular}
    \end{topcaptiontable}

	\begin{code}{}
		\codeitem \ref{trw:populationmean}) testStatistic, pValue = scipy.stats.ttest\_1samp(\ldots)
	\end{code} 